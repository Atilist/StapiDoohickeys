...
public class CorruptionGrassWet extends TemplateBlock {

    int topTextureInternal;
    int sideTextureInternal;
    int bottomTextureInternal;

    public CorruptionGrassWet(Identifier identifier, Material material) {
    ...
    public void onTick(World world, int x, int y, int z, Random random) {
        ...
        if (world.getBlockId(x + randomX, y + randomY, z + randomZ) == BlockListener.corruptionGrass.id) {
