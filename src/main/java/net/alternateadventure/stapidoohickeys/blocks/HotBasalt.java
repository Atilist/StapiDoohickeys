...
public class HotBasalt extends FluidFalling {
    public HotBasalt(Identifier identifier, Material material, int tickRate) {
    ...
    public void onTick(World world, int x, int y, int z, Random random) {
        ...
        if (world.getBlockMeta(x, y, z) < 15 && surroundingLava - world.getBlockMeta(x, y, z) > 48) {
            world.setBlock(x, y, z, BlockListener.realisticLava.id, world.getBlockMeta(x, y, z));
            return;
        }
        ...
        } else if (random.nextInt(256) == 0 && world.getBlockId(x, y - 1, z) != BlockListener.realisticLava.id) {
            world.setBlock(x, y, z, BlockListener.basalt.id, world.getBlockMeta(x, y, z));
        }
    }
